...
// auto setSOTimeStam(int fd) -> bool ; 
// auto wouldBlock() -> bool ; 
// auto setNcastTTL(int fd, int ttl) -> bool ; 
// auto setTTL(int fd, int ttl) -> bool ;  
// auto join(int fd, const std::string &ip, const std::string& iface, int port) -> bool  ;  
// auto createSocket(Logger& logger, const std::string t_ip, const std::string &iface, int pot, bool is_udp,
